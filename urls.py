...
urlpatterns = patterns('',
 ...
 (r'^favorites/(\d*)$','reader.views.list_favorites'),
 (r'^delete_entry/$','reader.views.delete_entry'),
 (r'^favorite_entry/$','reader.views.favorite_entry'),
 ...
 (r'^group/(\d+)/topic/(\d+)$','reader.views.list_group_topic'),
 (r'^topic/(\d+)$','reader.views.list_topic'),
 (r'^start_group_topic/$','reader.views.start_group_topic'),
 ...
 (r'^group/(\d+)/folder/(\d+)$','reader.views.list_group_folder'),
 ...
 (r'^folders/(\d*)$','reader.views.list_folders'),
 (r'^folder/(\d+)$','reader.views.list_folder_entries'),
 (r'^folder/(\d+)/edit$','reader.views.edit_folder'),
 (r'^pair/(\d+)/save/$','reader.views.pair_save'),
